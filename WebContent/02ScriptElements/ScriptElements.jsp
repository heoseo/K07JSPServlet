<%--
	* JSP의 스크립트 요소들
	 (1) 지시자(Directive)  <%@ 
		: 페이지 속성을 지정하거나 외부문서를 포함(include)할 때 사용한다.
 --%>
...
<%--
	 (2) 선언부(Declaration) <%!
		: 스크립트렛이나 표현식에서 사용할 메소드를 선언할 떄 사용한다.
...
<body>
	...
	<%--
		 (3) 스크립트릿(scriptlet)
		 	: 주로 JSP코드를 작성하고 실행할 떄 사용하는 영역이다.
	...
	<%--
		 (4) 표현식(Expressiont)
		 	: 변수를 웹브라우저상에 출력할 떄 사용한다.
		 	: JS의 document.write()와 동일한 역할을 한다.
		 	: 표현식 사용시 주의할 점은 문장끝네 ;(세미콜론)을 생략해야 하는 것!!!
 	 --%>
